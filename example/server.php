...
if (preg_match('/getdhbasedata/', $uri['path'])) {
    ...
    echo json_encode(array(
        'p' => $result['p'],
        'g' => $result['g'],
        'server_number'           => $result['server_number'],
        'processed_server_number' => $result['processed_server_number'],
    ...
    $key   = dh_compute_share_key( $postData['client_number'], $ret['server_number'], $ret['p'] );
    if (!$key) {
